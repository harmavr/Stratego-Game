...
public class Dragon extends MovablePiece{
	...
	/**
	 * constructor:κατασκευαζει ενα Δρακο
	 * Postcondition: δημιουργει και αρχικοποιει ενα νεο Δρακο με τα δωθεν χαρακτηριστικα
	 * @param live αν ζει
	...
	*/
	...
	/**
	 * transformer:οριζει το αν ο Δρακος ζει
	...
	/**
	 * accessor:επιστρεφει αν ο Δρακος ειναι ζωντανος
	 * postcondition:πρεπει να επιστρεψει αν ο Δρακος ειναι ζωντανος
	 * @return live
	 */
	 ...
	 * postcondition:αν εχει νικησει την επιθεση εκχωρει τον αντιπαλο στον πινακα pieceOffBoard αλλιως εκχωρει τον επιτεθεμενο
	...
	/**
	 * accessor:επιστρεφει αν ο Δρακος βρισκεται στην περιοχη οπου μπορει να διασωσει ενα πιονι
	 * postcondition:πρεπει να επισρεψει αν ο Δρακος βρισκεται στην περιοχη οπου μπορει να διασωσει ενα πιονι
	 * @return position
	 */
	...
	/**
	 * transformer:οριζει το ποσες διασωσεις εχει κανει ενας Δρακος
	...
	/**
	 * accessor:επιστρεφει ποσες διασωσεις εχει κανει ενας Δρακος
	 * postcondition:πρεπει να επιστρεψει το ποσες διασωσεις εχει κανει ενας Δρακος
	 * @return numOfResques
	 */
