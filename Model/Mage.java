...
public class Mage extends MovablePiece  {
	...
	protected Board1 board1;
	
	
	/**
	 * constructor:κατασκευαζει ενα Μαγο
	 * Postcondition: δημιουργει και αρχικοποιει ενα νεο Μαγο με τα δωθεν χαρακτηριστικα
	 * @param live αν ζει
	...
	*/
	public Mage(boolean live, int power, int x,int y,Model.Board1.PieceColor color) {
		super(true);
		this.power=9;
	...
	/**
	* transformer:οριζει το αν ο Μαγος ζει
	...
	*/
	...
	/**
	 * accessor:επιστρεφει αν ο Μαγος ειναι ζωντανος
	 * postcondition:πρεπει να επιστρεψει αν ο Μαγος ειναι ζωντανος
	 * @return live
	 */
	...
	/**
	 * οbserver:επιθεση του Μαγου σε ενα αντιπαλο
	 * postcondition:αν εχει νικησει την επιθεση εκχωρει τον αντιπαλο στον πινακα pieceOffBoard αλλιως εκχωρει τον Μαγο
	* @param element το πιονι που κανει την επιθεση
	...
	public int attack(Piece element,int x1,int y1,int x2,int y2,Piece element2,Piece [][] board,int i){
			...
			if(board[x1][y1] instanceof Flag ){
				...
				else if(7<((Piece)element2).getPower()){
					element.live=false;
					element2.live=true;
				//	board[x2][y2]=null;
						i= 2;
	...
	/**
	 * observer:μετακινηση του Μαγου 
	 * postcondition:ελεγχος αν μπορει να παει ο Μαγος στη συγκεκριμενη θεση και τις πιθανες θεσεις που μπορει να μετακινηθει
	...
	/**
	 * accessor:επιστρεφει αν ο Μαγος βρισκεται στην περιοχη οπου μπορει να διασωσει ενα πιονι
	 * postcondition:πρεπει να επισρεψει αν ο Μαγος βρισκεται στην περιοχη οπου μπορει να διασωσει ενα πιονι
	 * @return position
	 */
	...
	/**
	 * transformer:οριζει το ποσες διασωσεις εχει κανει ενας Μαγος
	...
	/**
	 * accessor:επιστρεφει ποσες διασωσεις εχει κανει ενας Μαγος
	 * postcondition:πρεπει να επιστρεψει το ποσες διασωσεις εχει κανει ενας Μαγος
	 * @return numOfResques
	 */
