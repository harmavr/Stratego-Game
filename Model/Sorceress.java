...
public class Sorceress extends MovablePiece  {
	...
	/**
	 * constructor:κατασκευαζει μια Μαγισσα
	 * Postcondition: δημιουργει και αρχικοποιει μια νεα Μαγισσα με τα δωθεν χαρακτηριστικα
	  * @param live αν ζει
	...
	*/
	public Sorceress(boolean live, int power, int x,int y,Model.Board1.PieceColor color) {
		super(true);
		this.power=6;
	...
	/**
	* transformer:οριζει το αν η Μαγισσα ζει
	...
	*/
	...
	/**
	 * accessor:επιστρεφει αν η Μαγισσα ειναι ζωντανη
	 * postcondition:πρεπει να επιστρεψει αν η Μαγισσα ειναι ζωντανη
	 * @return live
	 */
	...
	/**
	 * οbserver:επιθεση της Μαγισσας σε ενα αντιπαλο
	 * postcondition:η μαγισσα επιτεθηκε
	...
	/**
	 * observer:μετακινηση της Μαγισσας 
	 * postcondition:ελεγχος αν μπορει να παει η Μαγισσα στη συγκεκριμενη θεση και τις πιθανες θεσεις που μπορει να μετακινηθει
	...
	/**
	 * accessor:επιστρεφει αν η Μαγισσα βρισκεται στην περιοχη οπου μπορει να διασωσει ενα πιονι
	 * postcondition:πρεπει να επισρεψει αν η Μαγισσα βρισκεται στην περιοχη οπου μπορει να διασωσει ενα πιονι
	 * @return position
	 */
	...
	/**
	 * transformer:οριζει το ποσες διασωσεις εχει κανει η Μαγισσα
	...
	/**
	 * accessor:επιστρεφει ποσες διασωσεις εχει κανει η Μαγισσα
	 * postcondition:πρεπει να επιστρεψει το ποσες διασωσεις εχει κανει η Μαγισσα
	 * @return numOfResques
	 */
