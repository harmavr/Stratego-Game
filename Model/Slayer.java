...
public class Slayer extends MovablePiece  {
	...
	/**
	 * constructor:κατασκευαζει ενα Εξολοθρευτη
	 * Postcondition: δημιουργει και αρχικοποιει ενα νεο Εξολοθρευτη με τα δωθεν χαρακτηριστικα
	 * @param live αν ζει
	...
	*/
	public Slayer(boolean live, int power, int x,int y,Model.Board1.PieceColor color) {
		super(true);
		this.power=1;
	}
	...
	/**
	* transformer:οριζει το αν ο Εξολοθρευτης ζει
	...
	*/
	...
	/**
	 * accessor:επιστρεφει αν ο Εξολοθρευτης ειναι ζωντανος
	 * postcondition:πρεπει να επιστρεψει αν ο Εξολοθρευτης ειναι ζωντανος
	 * @return live
	 */
	...
	/**
	 * οbserver:επιθεση ενος Εξολοθρευτη σε ενα αντιπαλο
	 * postcondition:αν εχει νικησει την επιθεση εκχωρει τον αντιπαλο στον πινακα pieceOffBoard αλλιως εκχωρει τον Εξολοθρευτη
	 ...
	 * (αν i=1 τοτε το πιονι νικησε,  αν i=2 το πιονι εχασε , αν i=3 ηρθε ισοπαλια, αν i=5 ο ελφ επιτεθηκε σε δρακο)
	 */
	public int attack(Piece element,int x1,int y1,int x2,int y2,Piece element2,Piece [][] board,int i){
		...
		if((board[x1][y1] instanceof Dragon) &&((x1==x2+1 && y1==y2 )|| (y1==y2+1 && x1==x2) || (x1==x2-1 && y1==y2)|| (y1==y2-1 && x1==x2))&& board[x1][y1].getColor()!=board[x2][y2].getColor()){
	...
	/**
	 * observer:μετακινηση ενος Εξολοθρευτη
	 * postcondition:ελεγχος αν μπορει να παει ο Εξολοθρευτης στη συγκεκριμενη θεση και τις πιθανες θεσεις που μπορει να μετακινηθει
	...
	/**
	 * accessor:επιστρεφει αν ο Εξολοθρευτης βρισκεται στην περιοχη οπου μπορει να διασωσει ενα πιονι
	 * postcondition:πρεπει να επισρεψει αν ο Εξολοθρευτης βρισκεται στην περιοχη οπου μπορει να διασωσει ενα πιονι
	 * @return position
	 */
	...
	/**
	 * transformer:οριζει το ποσες διασωσεις εχει κανει ενας Εξολοθρευτης
	...
	/**
	 * accessor:επιστρεφει ποσες διασωσεις εχει κανει ενας Εξολοθρευτης
	 * postcondition:πρεπει να επιστρεψει το ποσες διασωσεις εχει κανει ενας Εξολοθρευτης
	 * @return numOfResques
	 */
